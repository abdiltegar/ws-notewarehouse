...
$query_barang = mysqli_query($koneksi, "SELECT ab.*, jb.nama_barang, jb.satuan, r.nama_ruangan FROM arus_barang AS ab LEFT JOIN jenis_barang AS jb ON ab.kode_barang = jb.kode_barang LEFT JOIN ruangan AS r ON ab.kode_ruangan = r.kode_ruangan WHERE ab.apakah_masuk = TRUE ORDER BY ab.tanggal DESC");
